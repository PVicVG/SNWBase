///draw_circular_bar(x , y, value, max, colour, radius, transparency, width, back, back color)

// Draw Back Bar
    if (argument8 == true)
    {
        draw_circular_bar(argument0, argument1, 1, 1, argument9, argument5, argument6, argument7, false, -1);
    }
